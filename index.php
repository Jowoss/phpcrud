    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <form method="POST" style="display: inline;">
            <input type="hidden" name="id"  value="<?php echo $rows['user_id']; ?>">
            <input type="submit" class="btn btn-danger btn-sm" value="delete" name="delete" onclick="return confirm('Are you sure you want to delete this user?')">
        </form>
          </td>
        </tr>
        <?php
        ...
        <div class="card-container">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><strong>Username:</strong> <?php echo htmlspecialchars($rows['firstname']); ?></p>
