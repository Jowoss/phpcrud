...
if (isset($_POST['Multisave'])) {
    ...
    if ($password == $confirm) {
        ...
        $user_id = $con->signupUser($username,$password,$firstname,$lastname,$sex,$birthday); // Insert into users table and get user_id
        if ($user_id) {
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="user_street" placeholder="Enter street">
        </div>
        <div class="form-row">
          <div class="form-group col-md-6">
            <label for="barangay">Barangay:</label>
            <input type="text" class="form-control" name="user_barangay" placeholder="Enter barangay">
          </div>
          <div class="form-group col-md-6">
            <label for="city">City:</label>
            <input type="text" class="form-control" name="user_city" placeholder="Enter city">
          </div>
        </div>
        <div class="form-group">
          <label for="province">Province:</label>
          <input type="text" class="form-control" name="user_province" placeholder="Enter province">
        </div>
      </div>
    </div>
